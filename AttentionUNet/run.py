...
def parse_args():
    p = argparse.ArgumentParser(description="Train + test pipeline for AttentionUNet.")
    p.add_argument("--data_root", type=str, default="/home/wusi/Project_crop/Data/Eso_83/EsoCTV_All")
    p.add_argument("--save_root", type=str, default="/home/wusi/Project_crop/Data/Eso_83/Networks/AttentionUNet/EsoCTV_All")
    ...
    p.add_argument("--f1", type=int, default=32)
    p.add_argument("--f2", type=int, default=64)
    p.add_argument("--f3", type=int, default=128)
    p.add_argument("--f4", type=int, default=256)
    p.add_argument("--f5", type=int, default=512)
