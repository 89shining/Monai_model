...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sequential runner: VNet/run_all.py -> AttentionUNet/run_all.py")
    ...
    parser.add_argument("--state", type=str, default="runner_vnet_attention_all_state.json", help="State file under MyTrain")
    parser.add_argument("--gpu", type=str, default=os.environ.get("CUDA_VISIBLE_DEVICES", "2"), help="GPU id")
    ...
    master_log = log_dir / "vnet_attention_all_master.log"

    models = [
        {"name": "VNet", "run_py": root / "VNet" / "run_all.py", "workdir": root / "VNet", "log": log_dir / "vnet_all.log"},
        {"name": "AttentionUNet", "run_py": root / "AttentionUNet" / "run_all.py", "workdir": root / "AttentionUNet", "log": log_dir / "attentionunet_all.log"},
    ]
